...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".home").backstretch("./img/Beach.jpg");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function onViewChange (elem, callback) {
	    var old_visible;
	    return function () {
	        var visible = isInView(elem);
	...
	var handler = onViewChange (skill_box, function(visible) {
	    $(".skill-item").each( function(i) {
	        var l = $(".title-value", this).text();
	        if (visible){
	            $(".bar-fill", this).css("width", l);
	        } else {
	            $(".bar-fill", this).css("width", 0);
	        }
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".nav-button").each( function(i) {
	    var e_id = $(this).attr("target");

	    $(this).click( function() {
	        $("html, body").animate({
	            scrollTop: $(e_id).offset().top
	        }, 500);
	    });
	});
